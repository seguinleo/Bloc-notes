...
try {
    $query = $PDO->prepare("INSERT INTO notes (id,title,content,dateNote,color,hiddenNote,category,folder,user) VALUES (:NoteId,:Title,:Content,:DateNote,:Color,:HiddenNote,:Category,:Folder,:User)");
    $query->execute(
        [
            ':NoteId'       => $noteId,
