...
try {
    $query = $PDO->prepare("INSERT INTO notes (id,title,content,dateNote,color,hiddenNote,category,user) VALUES (:NoteId,:Title,:Content,:DateNote,:Color,:HiddenNote,:Category,:User)");
    $query->execute(
        [
            ':NoteId'       => $noteId,
